...
namespace Data.Database
{
    public class Adapter
    {
        ...
        const string consKeyDefaultCnnString = "Server= localhost; Database = miTP2v1; Trusted_Connection = True";
        public SqlConnection sqlConn
        { set; get; }
        protected void OpenConnection()
        {
            //string miConString = ConfigurationManager.ConnectionStrings[consKeyDefaultCnnString].ConnectionString;
            string miConString = "Server=localhost; Database = miTP2v1; Trusted_Connection = True";
